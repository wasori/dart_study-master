...
void main(List<String> args) {
  ...
  List tempList2 = [4, 3, 2, 1];
  print(tempList2.map((e) => 2 * e));

  // 문제 11. where를 이용해서 tempList1의 짝수만 출력하시오.
  print(tempList2.where((element) => element % 2 == 0));
